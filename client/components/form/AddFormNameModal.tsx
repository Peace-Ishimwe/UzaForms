...
import { useCreateFormName } from '@/hooks/form/useFormNames';
...
export const AddFormNameModal: React.FC = () => {
    ...
    const createFormNameMutation = useCreateFormName();
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const data = await createFormNameMutation.mutateAsync(
                {
            ...
            console.error(error);
            toast.error('Failed to add form name');
        }
    };
    ...
    return (
        <div>
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Add Form Name</DialogTitle>
                    </DialogHeader>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            ...
                            <SearchGroup setGroupId={setGroupNameId} />
                        </div>
                        <div className="mb-4">
                            <label className="block text-sm font-medium text-gray-700">Status</label>
                            <select
                        ...
                        <div className="flex justify-end space-x-4">
                            ...
                            >
                                {createFormNameMutation.isPending ? (
                                    <p>Creating...</p>
                                ) : (
                                    <p>Add</p>
                                )}
